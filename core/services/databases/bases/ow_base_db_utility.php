...
abstract class OW_Base_Db_Utility implements  OW_Utility_Db_Interface {
     ...
     * @return	string
     */
    public function csv_from_result(OW_Base_Result $query, $delim = ',', $newline = "\n", $enclosure = '"')
    {
        $out = '';
     ...
     * @return	string
     */
    public function xml_from_result(OW_Base_Result $query, $params = array())
    {

...
class OW_Base_Db_Driver extends OW_Base_Db_Query_Builder implements  OW_Db_Driver_Interface {
     ...
     * Queries list
     *
     * @see	OW_Base_Db_Driver::$save_queries
     * @var	string[]
     */
     ...
     * COUNT string
     *
     * @used-by	OW_Base_Db_driver::count_all()
     * @used-by	OW_Base_Db_Query_Builder::count_all_results()
     *
     * @var	string
     */
    ...
    public function query($sql, $binds = FALSE, $return_object = NULL)
    {
        ...
        if (FALSE === ($this->result_id = $this->simple_query($sql)))
        {
            ...
            // Log errors
            debug('error  ' . 'Query error: '.$error['message'].' - Invalid query: '.$sql);
            ...
            if ($this->db_debug)
            {
                ...
                while ($this->_trans_depth !== 0)
                {
                    ...
                    {
                        debug('error', 'Database: Failure during an automated transaction commit/rollback!');
                        break;
                    }
                }
        ...
        $driver	= 'OW_'. ucwords($this->dbdriver) .'_Db_Result';
        $RES    = new $driver($this);
    ...
    {
        if ( ! class_exists('OW_Base_Db_Cache', FALSE))
        {
        ...
        $this->CACHE = new OW_Base_Db_Cache($this); // pass db object to support multiple db connections and returned db objects
        return TRUE;
    }
    ...
    {
        // TODO: Implement db_set_charset() method.
    }
}